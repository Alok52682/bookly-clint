...
const MostRead = () => {
    return (
        <div className='my-10 w-11/12 mx-auto p-5 border rounded-xl shadow-xl'>
            ...
            <div className='grid grid-cols-2 gap-3 md:grid-cols-6 justify-around bg-white p-5'>
                ...
                <div className='flex flex-col items-center hover:text-red-600'>
                    ...
                    <h2 className='text-xl font-semibold'>100 Must Reads</h2>
                </div>
                <div className='flex flex-col items-center hover:text-red-600'>
                ...
                <div className='flex flex-col items-center hover:text-red-600'>
                    ...
                    <h2 className='text-xl font-semibold'>Author Recomended</h2>
                </div>
                <div className='flex flex-col items-center hover:text-red-600'>
                    <img src="https://i.ibb.co/wBxcJH5/certificate-6576093.png" className='w-20 cursor-pointer' alt="" />
                    <h2 className='text-xl font-semibold'>Awerd Winners</h2>
                </div>
                <div className='flex flex-col items-center hover:text-red-600'>
